...
public class CustomSQLConnectorTest {
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("create table custom_table(id int,name string)with(" + "'connector'='custom'," +
                "'custom.path'='/Users/huangshimin/Documents/study/flink-learn/flink-1.13-study/src/main/resources/data/custom-data.csv'," + " 'format' = 'csv',\n" + " 'csv.ignore-parse-errors' = 'true',\n" + " 'csv" +
                ".allow-comments' = 'true')");
